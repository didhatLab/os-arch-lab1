...
typedef struct IEcoLab1VTbl {
    ...
    /* Bucket sort methods */
    int16_t (ECOCALLMETHOD *BucketSortInt)(/* in */ IEcoLab1Ptr_t me, /* in,out */ int* array, /* in */ uint32_t length);
    int16_t (ECOCALLMETHOD *BucketSortLong)(/* in */ IEcoLab1Ptr_t me, /* in,out */ long* array, /* in */ uint32_t length);
    int16_t (ECOCALLMETHOD *BucketSortFloat)(/* in */ IEcoLab1Ptr_t me, /* in,out */ float* array, /* in */ uint32_t length);
